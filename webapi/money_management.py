#--------------------------------------------------------------------------------- location
# webapi/routes/money_management.py

#--------------------------------------------------------------------------------- Description
# This is route for money_management

#--------------------------------------------------------------------------------- Import
from logic.util import model_output
from logic.startup import database_management
from fastapi import APIRouter, Request
from model.money_management import model_money_management_py as model_py
from model.money_management import model_money_management_db as model_db
