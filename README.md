...
Download
```bash
.env/bin/python ./download.py account=acc-history1 instrument=all timeframe=W1,D1,H8,H6,H4,H3,H2,H1 mode=down save=False bulk=True clear=False count=25000
