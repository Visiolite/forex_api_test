...
config_postgres()
{
    ...
    #----------Database
    echo -e "${verbose_color}sudo -u postgres psql -c \"CREATE DATABASE data WITH OWNER=${username};\"${ENDCOLOR}"
    ...
    sudo -u postgres psql -c "CREATE DATABASE data WITH OWNER=${username};"
    ...
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"ALTER ROLE ${username} WITH CONNECTION LIMIT -1;\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"ALTER DATABASE data OWNER TO ${username};\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"ALTER SCHEMA public OWNER TO ${username};\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"GRANT ALL PRIVILEGES ON SCHEMA public TO ${username};\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"GRANT USAGE ON SCHEMA public TO ${username};\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"GRANT CREATE ON SCHEMA public TO ${username};\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO ${username};\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO ${username};\"${ENDCOLOR}"
    echo -e "${verbose_color}sudo -u postgres psql -d data -c \"GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO ${username};\"${ENDCOLOR}"
    sudo -u postgres psql -d data -c "ALTER ROLE ${username} WITH CONNECTION LIMIT -1;"
    sudo -u postgres psql -d data -c "ALTER DATABASE data OWNER TO ${username};"
    sudo -u postgres psql -d data -c "ALTER SCHEMA public OWNER TO ${username};"
    sudo -u postgres psql -d data -c "GRANT ALL PRIVILEGES ON SCHEMA public TO ${username};"
    sudo -u postgres psql -d data -c "GRANT USAGE ON SCHEMA public TO ${username};"
    sudo -u postgres psql -d data -c "GRANT CREATE ON SCHEMA public TO ${username};"
    sudo -u postgres psql -d data -c "GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO ${username};"
    sudo -u postgres psql -d data -c "GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO ${username};"
    sudo -u postgres psql -d data -c "GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO ${username};"
